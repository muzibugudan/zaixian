...
<div class="x-body">
    <form class="layui-form" id="art_form" action="{{ url('admin/article') }}" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <script id="container" name="art_content" type="text/plain" style="height: 500px">
                ...
                <!-- <script id="container" type="text/plain" name="art_content" style="width:600px;height:300px;"></script> -->
...
<script>
    layui.use(['form','layer','upload','element','btn'], function(){
        $ = layui.jquery;
        var form = layui.form
            ,layer = layui.layer;
