    ...
    <div class="x-body">
        <form class="layui-form">
            ...
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">缩略图</label>
                <div class="layui-input-block">
                    <img src="{{ $arts->art_thumb }}" alt="" name="art_thumb" id="art_thumb_img" style="max-width: 350px; max-height:100px;">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <script id="editor" type="text/plain" name="art_content" style="width:1200px; height: 500px">{!! $arts->art_content !!}</script>
