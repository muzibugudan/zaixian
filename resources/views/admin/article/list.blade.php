...
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <table class="layui-table">
        <thead>
          <tr>
            ...
            <th>ID</th>
            <th>文章标题</th>
            <th style="width:75px">关键字</th>
            <th style="text-align: center;">描述</th>
            <th style="width:75px">文章分类</th>
            <th>添加时间</th>
            <th>作者</th>
            <th>操作</th>
          </tr>
        ...
        @foreach($arts as $v)
          <tr>
            ...
            <td style="width:25px">{{$v->art_id}}</td>
            <td>{{$v->art_title}}</td>
            <td style="width:50px">{{$v->art_tag}}</td>
            <td>{{$v->art_description}}</td>
            <td>{{$v->cate_name}}</td>
            <td style="width:100px">{{date('Y-m-d',$v->art_time)}}</td>
            <td style="width:50px">{{$v->art_editor}}</td>
            {{--<td class="td-status">--}}
      ...
      <div class="page">
       {!! $arts->appends($request->all())->render() !!}
      </div>
    </div>
    <script>
