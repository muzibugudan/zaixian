...
<header>
  ...
  <div class="log-re">
    <a href="/login"><button type="button" class="am-btn am-btn-default am-radius log-button">登 录</button></a>
  </div> 
</header>
...
<div class="log"> 
  ...
  <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
    ...
    <br>
    <form class="am-form" id="log-form" action="{{ url('emailReg') }}" method="post">
      {{ csrf_field() }}
      ...
      <br>
      <div class="am-input-group am-radius am-animation-slide-left">       
        <input type="text" name="phone" id="doc-vld-phone-2-1" class="am-radius" data-validation-message="请输入正确手机号码" placeholder="手机号码" required/>
      ...
      <div class="am-input-group am-animation-slide-left log-animation-delay">       
        <input type="password" id="log-password" name="user_pass" class="am-form-field am-radius log-input" placeholder="密码" minlength="5" required>
        <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
      </div>
      <br>   
      <div class="am-input-group am-animation-slide-left log-animation-delay-a">       
        <input type="password" name="user_repass" data-equal-to="#log-password" class="am-form-field am-radius log-input" placeholder="确认密码" data-validation-message="请确认密码一致" required>
        <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
      </div>
      <br>
